...
Work_with_NTFS::Work_with_NTFS(BYTE * BufferRecord, HANDLE fileHandle)
{
	NTFS_BootRecord * pBootRecord = (NTFS_BootRecord *)BufferRecord;
...
bool Work_with_NTFS::ReadClusters(ULONGLONG startCluster, DWORD numberOfClusters, BYTE * outBuffer)
{
	DWORD bytesToRead;
	DWORD bytesRead;
